...
data_path = 'agrupacion_de_alumnos.csv'
...
def predecir():
    if request.method == 'POST':
        try:
            ...
            return redirect(url_for('resultado', nombre=nombre, grupo=prediccion, nota=nota, comportamiento=comportamiento, imagen=imagen))
